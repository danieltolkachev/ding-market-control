...
- **Sleeves (7, NEW — part of `REGISTRATION_V2`, unlike v1 where `SLEEVES` was a bare module constant NOT covered by `config_hash()`):** us_equity=[SPY,QQQ,IWM], intl_equity=[EFA,EEM], bonds=[TLT,IEF,LQD], em_bonds=[EMB], real_assets=[GLD,SLV,DBC,VNQ], currencies=[UUP,FXE,FXY], granular_commodities=[USO,UNG,DBA].
